...
class TestConfig(unittest.TestCase):
    core_config = {
        ...
        'basic_project': {'core': 'basic_src'},
        'front_end_portfolio': {'core': 'front_end_src'},
    }
    ...
    def test_select_project_03(self):
        test_type = 'BASIC'
        assert Config.select_project(test_type, self.core_config) == 'basic_src'

    def test_select_project_04(self):
        test_type = 'FRONTEND'
        assert Config.select_project(test_type, self.core_config) == 'front_end_src'
